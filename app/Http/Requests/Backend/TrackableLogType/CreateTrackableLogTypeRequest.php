...
namespace App\Http\Requests\Backend\TrackableLogType;

use Illuminate\Foundation\Http\FormRequest;

class CreateTrackableLogTypeRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-trackablelogtype');
    }
