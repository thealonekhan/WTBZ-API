...
namespace App\Http\Requests\Backend\ZumhicacheMemberships;

use Illuminate\Foundation\Http\FormRequest;

class CreateZumhiCacheMembershipRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-zumhicachemembership');
    }
