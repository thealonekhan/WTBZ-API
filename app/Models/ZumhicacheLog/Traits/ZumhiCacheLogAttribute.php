...
/**
 * Class ZumhiCacheLogAttribute.
 */
trait ZumhiCacheLogAttribute
{
    ...
    {
        return '<a target="_self" href="'.route('admin.zumhicachelogs.show', $this->id).'" class="btn btn-flat btn-default">
