<!--Action Button-->
@if( Active::checkUriPattern( 'admin/zumhicacheusers' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.zumhicacheusers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.zumhicacheusers.all' ) }}
            </a>
        </li>
        @permission( 'create-zumhicacheuser' )
            <li>
                <a href="{{ route( 'admin.zumhicacheusers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.zumhicacheusers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
