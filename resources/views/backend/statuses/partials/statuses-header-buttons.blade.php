<!--Action Button-->
@if( Active::checkUriPattern( 'admin/statuses' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.statuses.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.statuses.all' ) }}
            </a>
        </li>
        @permission( 'create-status' )
            <li>
                <a href="{{ route( 'admin.statuses.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.statuses.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
