<!--Action Button-->
@if( Active::checkUriPattern( 'admin/logtypes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.logtypes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.logtypes.all' ) }}
            </a>
        </li>
        @permission( 'create-logtype' )
            <li>
                <a href="{{ route( 'admin.logtypes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.logtypes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
