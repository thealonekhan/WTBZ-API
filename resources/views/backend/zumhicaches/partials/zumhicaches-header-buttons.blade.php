<!--Action Button-->
@if( Active::checkUriPattern( 'admin/zumhicaches' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.zumhicaches.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.zumhicaches.all' ) }}
            </a>
        </li>
        @permission( 'create-zumhicache' )
            <li>
                <a href="{{ route( 'admin.zumhicaches.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.zumhicaches.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
