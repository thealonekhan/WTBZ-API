<!--Action Button-->
@if( Active::checkUriPattern( 'admin/sponsors' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.sponsors.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.sponsors.all' ) }}
            </a>
        </li>
        @permission( 'create-sponsor' )
            <li>
                <a href="{{ route( 'admin.sponsors.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.sponsors.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
