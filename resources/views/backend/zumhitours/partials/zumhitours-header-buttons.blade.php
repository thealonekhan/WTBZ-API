<!--Action Button-->
@if( Active::checkUriPattern( 'admin/zumhitours' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.zumhitours.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.zumhitours.all' ) }}
            </a>
        </li>
        @permission( 'create-zumhitour' )
            <li>
                <a href="{{ route( 'admin.zumhitours.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.zumhitours.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
