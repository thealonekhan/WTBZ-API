<!--Action Button-->
@if( Active::checkUriPattern( 'admin/listzumhicaches' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.listzumhicaches.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.listzumhicaches.all' ) }}
            </a>
        </li>
        <!-- @permission( 'create-listzumhicache' )
            <li>
                <a href="{{ route( 'admin.listzumhicaches.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.listzumhicaches.create' ) }}
                </a>
            </li>
        @endauth -->
    </ul>
