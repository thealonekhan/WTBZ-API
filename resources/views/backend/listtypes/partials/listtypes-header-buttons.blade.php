<!--Action Button-->
@if( Active::checkUriPattern( 'admin/listtypes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.listtypes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.listtypes.all' ) }}
            </a>
        </li>
        @permission( 'create-listtype' )
            <li>
                <a href="{{ route( 'admin.listtypes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.listtypes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
