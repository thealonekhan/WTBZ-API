<!--Action Button-->
@if( Active::checkUriPattern( 'admin/zumhicachesizes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.zumhicachesizes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.zumhicachesizes.all' ) }}
            </a>
        </li>
        @permission( 'create-zumhicachesize' )
            <li>
                <a href="{{ route( 'admin.zumhicachesizes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.zumhicachesizes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
