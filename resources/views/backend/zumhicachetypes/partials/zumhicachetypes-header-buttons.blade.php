<!--Action Button-->
@if( Active::checkUriPattern( 'admin/zumhicachetypes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.zumhicachetypes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.zumhicachetypes.all' ) }}
            </a>
        </li>
        @permission( 'create-zumhicachetype' )
            <li>
                <a href="{{ route( 'admin.zumhicachetypes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.zumhicachetypes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
