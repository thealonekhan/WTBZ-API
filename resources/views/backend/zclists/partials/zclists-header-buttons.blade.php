<!--Action Button-->
@if( Active::checkUriPattern( 'admin/zclists' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.zclists.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.zclists.all' ) }}
            </a>
        </li>
        <!-- @permission( 'create-zclist' )
            <li>
                <a href="{{ route( 'admin.zclists.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.zclists.create' ) }}
                </a>
            </li>
        @endauth -->
    </ul>
