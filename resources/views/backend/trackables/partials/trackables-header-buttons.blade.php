<!--Action Button-->
@if( Active::checkUriPattern( 'admin/trackables' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.trackables.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.trackables.all' ) }}
            </a>
        </li>
        @permission( 'create-trackable' )
            <li>
                <a href="{{ route( 'admin.trackables.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.trackables.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
